// play on double click , using Jquery
...
//		const $				=	 document.querySelector.bind(document);
		...
		}, 		100);		// wait 100 ms, after playlist is rendering
	},
...
//		console.log('render audio - ' , audio);
...
//			console.log('22 - ' , audio);
	...
	render			: function () {
		...
		for (let i = 0 ; i < songs.length ; i++) {
			...
			songs[i].addEventListener("dblclick" ,  function (e) {
...
//				at the end of song , audio automatique on pause , reactive it
